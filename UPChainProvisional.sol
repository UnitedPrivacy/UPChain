...
// This contract is provisional to work with Decentralized Applications, and for trading purposes, this doesnt represents the final version of the United Privacy Chain Protocol.

// This token will be exchangeable 1:1 for UPC Mainnet Tokens.

contract UPCHAIN {
   
    string public constant name = "United Privacy Chain";
    ...
    constructor() public {
        ...
        treasury = address(0x25A40cD8B9602DC98382243Dca940049a9dA927C);  

        
        totalSupply = 2750000 * 10**uint(decimals);
